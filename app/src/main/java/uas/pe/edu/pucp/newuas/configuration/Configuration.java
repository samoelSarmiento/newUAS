...
public class Configuration {
    ...
    public static final String BASE_URL = "http://192.168.1.33/internetUAS/public";//"http://192.168.1.35/internetUAS/public";//"http://10.101.2.35/internetUAS/public";  //"http://52.89.227.55/api";
